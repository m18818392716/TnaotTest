package com.tnaot.utils.CommonUtils;

import com.tnaot.utils.AppiumUtils.AppiumComm;
...
public class TestListener extends TestListenerAdapter {
    ...
    static{
        ...
        try {
            InputStreamReader reader = new InputStreamReader(new FileInputStream("resource/config.properties"),"UTF-8");
            pp.load(reader);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        ProjectPath = pp.getProperty("../test-output/snapshot/");
